...
public class HeaderTemplate {
    ...
    public static void importHeaderEntity(StringBuilder stringBuilder, String groupId, String servicePackage, String domainPackage, String subPackage, Boolean hasValue, Boolean hasEnum) {
        stringBuilder
                ...
                .append("import ").append(groupId).append(".ddd.simplified.starter.common.config.utils.id.*;\n")
                .append("import ").append(groupId).append(".ddd.simplified.starter.common.utils.model.decimal.Decimal;\n")
